...
function myGetInfoForDisplayCard(){
    ...
    AppLog.info("limitDueToFormFactor:GetInforDisplayCard - " + limitDueToFormFactor);
    
    // number of loaded list items 
    var numberOfListItems = me.getCount();
    AppLog.info("numberOfListItems:GetInforDisplayCard - " + numberOfListItems);
    ...
    console.log("shownItems:GetInforDisplayCard - " + shownItems)
